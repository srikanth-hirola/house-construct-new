...
return (
    <>
        <div className='service-timing-parent'>
            <div className="service-timing-subparent">

                <div className="row">
                    <div className="col-md-6 ">

                        <div className='counting-images' >
                            <div className='images123'>
                                <img src="../servicepage/servicepage1.jpeg" alt="" />
                            </div>
                            <div className='images1234'>
                                <img src="../servicepage/servicepage2.jpg" alt="" />
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6">
